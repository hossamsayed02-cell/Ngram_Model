...
An end-to-end N-Gram language model designed to process raw text data, build a probabilistic model, and provide real-time next-word predictions. This project demonstrates modular software design, dependency injection, and robust text normalization using Project Gutenberg data.

## 📋 Features
- **Flexible N-Gram Support:** Configurable N-order (e.g., Unigrams through 4-grams).
...
- **Environment-Driven:** All file paths and hyperparameters are controlled via `.env` configuration.
